...
# @Distribute('alex', broutefore_iterator, int(1.5e7), './Results', parallel_func='create_hash',
...
# @Distribute('alex', range(10**8), 10**4, './Results', parallel_func='is_prime', only_if_func='write_num')
# class PrimesBellowN:
#
#     @classmethod
